  ...
  <?php include 'header.php'; ?>
		...
		<div class="container head-container"> 
			...
			<?php
				...
				$type_que = mysql_query("select * from category where cat_name = 'FACULTY'");
...
<!-- Notics -->
				...
				<div class="col-lg-4 col-md-12 custom-notics"> 
					...
					$sql = mysql_query("select * from notices ORDER BY `id` DESC LIMIT 0,3 ");$counter = 0;
					$max = 10;
		...
		<?php 	 	 	 	 
			$allnews = mysql_query("SELECT * FROM all_news where cat_id= '$news_cat_id_main' ORDER BY `id` DESC LIMIT $start_from , $per_page");
		...
		<div class="col-lg-4 col-md-6">
			...
			?>
			 <ul class="pager">
			 	...
			 	<li class="previous"><a href="facutti.php?page=1">Previous</a></li> 
				<?php
					for($ii <= 1; $ii <= $total_pages ; $ii++){
				?>   <li><a href="facutti.php?page=<?php echo $ii ?>"> <?php echo $ii ?> </a></li>
				<?php
					}
				?>

				<li class="next"><a  href="facutti.php?page=<?php echo $total_pages ?>">Next</a></li>
				<?php
